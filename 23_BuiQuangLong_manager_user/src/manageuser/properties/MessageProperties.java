 ...
 * MessageProperties.java, 17/11/2020 Bui Quang Long
 */
...
/**
 * 
 * class MessageProperties đọc file message_ja.properties
 * 
	...
	static {
		try {
			...
			properties.load(new InputStreamReader(
					MessageErrorProperties.class.getClassLoader().getResourceAsStream(Constant.PROPERTIES_MESSAGE_PATH),
					"UTF-8"));
