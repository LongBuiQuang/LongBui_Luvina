 ...
 * ConfigProperties.java, 17/11/2020 Bui Quang Long
 */
...
/**
 * 
 * class ConfigProperties đọc file ConfigProperties.properties
 * 
	...
	static {
		try {
			...
			properties.load(new InputStreamReader(
					MessageErrorProperties.class.getClassLoader().getResourceAsStream(Constant.PROPERTIES_CONFIG_PATH),
					"UTF-8"));
