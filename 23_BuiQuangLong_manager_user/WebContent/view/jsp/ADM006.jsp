...
<!-- Begin vung input-->	
	...
	<table  class="tbl_input"   border="0" width="80%"  cellpadding="0" cellspacing="0" >	
		...
		<tr>
			<td align="center" colspan="2">
				<div style="height:70px">${message}</div>
			</td>
		</tr>
		<tr>
			<td align="center" colspan="2">
				<input class="btn" type="button" value="OK" onclick="location.href='${pageContext.request.contextPath}/listUser.do?action=default'"/>
			</td>
		</tr>
	</table>
	</form>
